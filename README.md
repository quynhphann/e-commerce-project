...
<p style="font-size: 1.5em;">fdsfdThe <strong>visual editor</strong> on the right and the <strong>source editor</strong> on the left are linked <span style="color: #ffff00 !important;"><strong>together and the changes</strong> </span>are reflected in the other one as you type! <img src="https://html5-editor.net/images/smiley.png" alt="smiley" /></p>
